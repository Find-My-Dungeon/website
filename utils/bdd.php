...
function init_bdd() {
  $sql='
    CREATE TABLE IF NOT EXISTS `user` (
      ...
      `social_media_1` varchar(45) NOT NULL,
      `social_media_2` varchar(45) NOT NULL,
      `social_media_3` varchar(45) NOT NULL,
      `presentation_user` text NOT NULL,
      PRIMARY KEY (`id_user`),
    ...
    CREATE TABLE IF NOT EXISTS `adventurer` (
      ...
      KEY `id_user_idx` (`id_user_adventurer`),
